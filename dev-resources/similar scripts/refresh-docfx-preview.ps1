...
$previewRootPath = Join-Path $repoRoot 'docs-site\.previewroot\AddressLookup'
...
try
{
    ...
    Write-Host 'Open http://localhost:3000/AddressLookup/api/index.html to review the updated API reference.'
}
finally
{
    Pop-Location
